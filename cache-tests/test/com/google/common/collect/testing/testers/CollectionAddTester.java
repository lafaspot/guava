...
import static com.github.lafa.cache.collect.testing.features.CollectionFeature.FAILS_FAST_ON_CONCURRENT_MODIFICATION;
import static com.github.lafa.cache.collect.testing.features.CollectionFeature.RESTRICTS_ELEMENTS;
 ...
 * {@link com.github.lafa.cache.collect.testing.CollectionTestSuiteBuilder}.
 *
 * @author Chris Povirk
 * @author Kevin Bourrillion
 */
@SuppressWarnings("unchecked") // too many "unchecked generic array creations"
@Ignore // Affects only Android test runner, which respects JUnit 4 annotations on JUnit
		// 3 tests.
public class CollectionAddTester<E> extends AbstractCollectionTester<E> {
	 ...
	 * that tests of
	 * {@link java.util.Collections#checkedCollection(java.util.Collection, Class)}
	 * can suppress it with {@code FeatureSpecificTestSuiteBuilder.suppressing()}
	 * until
	 * <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6409434">Sun bug
	 ...
	 * seems more likely that code would depend on that behavior than on the other.
	...
	/**
	 * Returns the {@link Method} instance for {@link #testAdd_nullSupported()} so
	 * that tests of {@link java.util.TreeSet} can suppress it with {@code
	 * FeatureSpecificTestSuiteBuilder.suppressing()} until
	 * <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=5045147">Sun bug
	 * 5045147</a> is fixed.
	 */
	// reflection
	 ...
	 * {@link #testAdd_unsupportedNotPresent()} so that tests can suppress it with
