...
public final class Enums {
	...
	/**
	 * Returns the {@link Field} in which {@code enumValue} is defined. For example,
	 * to get the {@code
	 * Description} annotation on the {@code GOLF} constant of enum {@code Sport},
	 * use {@code
	 ...
	 * default enum constant. For example, {@code
	 ...
	 * type {@code
	 * enumClass} using {@link Enum#valueOf(Class, String)} and {@link Enum#name()}.
	 * The converter will throw an {@code IllegalArgumentException} if the argument
	 * is not the name of any enum constant in the specified enum.
	 *
	 * @since 16.0
	 */
