...
public abstract class Converter<A, B> implements Function<A, B> {
	 ...
	 *             if backward conversion is not implemented; this should be very
	 *             rare. Note that if backward conversion is not only unimplemented
	 *             but unimplement<i>able</i> (for example, consider a
	 *             {@code Converter<Chicken, ChickenNugget>}), then this is not
	 *             logically a {@code Converter} at all, and should just implement
	 *             {@link Function}.
	 */
	@ForOverride
	...
	/**
	 * Package-private non-final implementation of andThen() so only we can override
	 * it.
	 */
	 ...
	 * useful if the function instances already exist, or so that you can supply
	 * lambda expressions. If those circumstances don't apply, you probably don't
	 * need to use this; subclass {@code Converter} and implement its
	 * {@link #doForward} and {@link #doBackward} methods directly.
	 *
	 * <p>
