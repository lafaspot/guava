 ...
 *
 * <p>
 * All methods return serializable predicates as long as they're given
...
public final class Predicates {
	 ...
	 * alter the behavior of this predicate. If {@code components} is empty, the
	 ...
	 * won't alter the behavior of this predicate. If {@code components} is empty,
	 ...
	 * this predicate evaluates to {@code
	 * false}.
	 *
	 * <p>
	 ...
	 * <i>consistent with equals</i>. For example,
	 * {@code instanceOf(ArrayList.class)} will yield different results for the two
	 ...
	 * is assignable to (is a subtype of) {@code clazz}. Example:
	 *
	 * <pre>
	 * {
	 * 	&#64;code
	 ...
	 * potential users since it is always possible to use
