 ...
 * instances; see that class for information about migrating to
...
public final class Functions {
	 ...
	 * its argument and returns the result. It throws a {@link NullPointerException}
	 * on null input.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * <b>Warning:</b> as with all function types in this package, avoid depending
	 * on the specific {@code equals}, {@code hashCode} or {@code toString} behavior
	 * of the returned function. A future migration to {@code java.util.function}
	 * will not preserve this behavior.
	 *
	 * <p>
	 * <b>For Java 8 users:</b> use the method reference {@code Object::toString}
	 * instead. In the future, when this class requires Java 8, this method will be
	 * deprecated. See {@link Function} for more important information about the
	 * Java 8 transition.
	 */
	 ...
	 * unrecognized key (instead of an exception being thrown), you can use the
	 * method reference {@code map::get} instead.
	 */
	...
	private static class ForMapWithDefault<K, V> implements Function<K, V>, Serializable {
		...
		@Override
		public String toString() {
			// TODO(cpovirk): maybe remove "defaultValue=" to make this look like the method
			// call does
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use the method reference {@code predicate::test}
	 * instead.
	 */
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use the lambda expression {@code o -> supplier.get()}
	 * instead.
	 *
	 * @since 10.0
	 */
