...
import com.github.lafa.cache.base.Ascii;
...
public class AsciiTest extends TestCase {
	...
	/**
	 * The Unicode points {@code 00c1} and {@code 00e1} are the upper- and lowercase
	 * forms of A-with-acute-accent, {@code Á} and {@code á}.
	 */
	...
	public void testEqualsIgnoreCaseUnicodeEquivalence() {
		...
		// implementation of
		// Ascii.equalsIgnoreCase(), but it is a signal that its documentation may need
		// updating as
		// regards edge cases.
