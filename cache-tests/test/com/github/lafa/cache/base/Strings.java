...
public final class Strings {
	 ...
	 * @param minLength
	 *            the minimum length the resulting string must have. Can be zero or
	 *            negative, in which case the input string is always returned.
	 * @param padChar
	 *            the character to insert at the beginning of the result until the
	 ...
	 *            negative, in which case the input string is always returned.
	 * @param padChar
	 *            the character to append to the end of the result until the minimum
	 *            length is reached
	 * @return the padded string
	 */
