...
import static com.github.lafa.cache.lrucache.CacheBuilder.EMPTY_STATS;
import static com.github.lafa.cache.lrucache.LocalCacheTest.SMALL_MAX_SIZE;
...
import com.github.lafa.cache.lrucache.LocalCache.LocalLoadingCache;
...
public class LocalLoadingCacheTest extends TestCase {
	...
	public void testRecursiveComputation() throws InterruptedException {
		...
		LoadingCache<Integer, String> recursiveCache = CacheBuilder.newBuilder().weakKeys().weakValues()
