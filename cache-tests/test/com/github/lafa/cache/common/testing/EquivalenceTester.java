...
public final class EquivalenceTester<T> {
	...
	public EquivalenceTester<T> addEquivalenceGroup(T first, T... rest) {
		addEquivalenceGroup((List<T>) Arrays.asList(first, rest));
		return this;
	}

	public EquivalenceTester<T> addEquivalenceGroup(List<T> group) {
		delegate.addRelatedGroup(group);
		List<T> newGroup = new ArrayList<>(group);
		items.addAll(newGroup);
		return this;
	}
