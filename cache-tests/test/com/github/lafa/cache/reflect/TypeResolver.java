...
public final class TypeResolver {
  ...
  private static class TypeTable {
    ...
    final TypeTable where(Map<TypeVariableKey, ? extends Type> mappings) {
      Map<TypeVariableKey, Type> newMap = new HashMap<>(map);
  ...
  private static final class TypeMappingIntrospector extends TypeVisitor {
    ...
    private final Map<TypeVariableKey, Type> mappings =new HashMap<TypeResolver.TypeVariableKey, Type>();
    ...
    static Map<TypeVariableKey, Type> getTypeMappings(Type contextType) {
      ...
      return new HashMap<>(introspector.mappings);
    }
